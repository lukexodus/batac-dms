BEGIN;
SELECT set_config('app.current_user_id', '6faf133e-8d7e-41ad-be80-bdfa5f504d2c', true);
SELECT set_config('app.current_office_id', '00000000-0000-0000-0000-000000000000', true);
SELECT set_config('app.bypass_office_isolation', 'false', true);
