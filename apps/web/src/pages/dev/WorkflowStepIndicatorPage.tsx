...
const errorSteps: WorkflowStep[] = [
  ...
  },
  {
    ...
    label: 'First Reading',
    state: 'skipped',
    tooltip: 'Skipped due to urgency',
  },
  {
    id: 'committee_referral',
    label: 'Committee Referral',
    state: 'error',
    tooltip: 'Failed to notify committee members',
  },
  ...
  return (
    <div className="space-y-12 p-8">
      ...
      <div className="space-y-4">
        ...
        <p className="text-sm text-neutral-500">Exercising the skipped and error states.</p>
        <div className="rounded-lg border border-neutral-200 p-6">
          <WorkflowStepIndicator
            steps={errorSteps}
            currentStepId="committee_referral"
            orientation="horizontal"
          />
        </div>
      </div>
      ...
      <div className="space-y-4">
        ...
        <p className="text-sm text-neutral-500">Forced vertical orientation on all screen sizes.</p>
        <div className="rounded-lg border border-neutral-200 p-6">
          <WorkflowStepIndicator
            steps={standardSteps}
            currentStepId="vp_certification"
