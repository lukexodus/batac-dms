  ...
  return (
    <div className="mx-auto max-w-7xl space-y-12 p-8">
      <div>
        ...
        <h1 className="text-text-primary mb-2 text-3xl font-bold">CommitteeReferralBlock</h1>
        <p className="text-text-secondary max-w-2xl">
          Displays the committee referral status list for a document, showing submission status
          chips and optional avatar + timestamp for submitted committee reports.
        </p>
      </div>
      ...
      <section className="space-y-4">
        ...
        <div className="bg-surface-base border-border-default max-w-4xl rounded-lg border p-6 shadow-sm">
