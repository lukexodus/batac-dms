 ...
 */
export const rlsStore = new AsyncLocalStorage();
async function databasePlugin(fastify) {
    ...
    const proxyHandler = {
        get(target, prop, receiver) {
            ...
            return function (...args) {
                ...
                const activeValue = Reflect.get(activeTarget, prop, activeTarget === target ? receiver : activeTarget);
    ...
    const db = new Proxy(baseDb, proxyHandler);
