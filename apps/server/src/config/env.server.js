import { z } from 'zod';
const booleanFromString = (defaultValue) => z
    .enum(['true', 'false'])
...
export const serverEnvSchema = z
    ...
    CORS_ALLOWED_ORIGINS: z.string().transform((s) => s
        .split(',')
        .map((o) => o.trim())
        .filter(Boolean)),
    ...
    AUTH_ACCESS_TOKEN_COOKIE_NAME: z.string().default('batac_at'),
    AUTH_REFRESH_TOKEN_COOKIE_NAME: z.string().default('batac_rt'),
