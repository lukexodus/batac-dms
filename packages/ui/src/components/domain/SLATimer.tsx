...
export function SLATimer({ deadlineAt, startedAt, label, className }: SLATimerProps) {
  const now = new Date();
  ...
  return (
    <div role="timer" aria-label={label} aria-live="polite" className={cn('space-y-2', className)}>
