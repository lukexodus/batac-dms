...
import { Button, buttonVariants } from '@batac/ui/components/ui/button';
...
function CalendarDayButton({
  ...
  return (
    <Button
      ...
      {...{
        [modifiers['focused'] ? 'aria-focused' : '']: true,
        [modifiers['selected'] ? 'aria-selected' : '']: true,
        [modifiers['range_start'] ? 'aria-range-start' : '']: true,
        [modifiers['range_end'] ? 'aria-range-end' : '']: true,
        [modifiers['range_middle'] ? 'aria-range-middle' : '']: true,
      }}
      className={cn(
