    ...
    steps: [
      {
        ...
        config: { assignee: ROLE.SECRETARIAT_STAFF, form_key: "form.sp_resolution.intake", require_comment: false, allow_comment: true, auto_complete: false },
      },
      {
        ...
        config: { assignee: ROLE.SP_SECRETARY, form_key: "form.sp_resolution.order_of_business", require_comment: false, allow_comment: true, auto_complete: false },
      },
      {
        ...
        position: 3,
        legally_mandated: true,
        config: { assignee: ROLE.SP_SECRETARY, form_key: "form.sp_resolution.first_reading", require_comment: false, allow_comment: true, auto_complete: false },
      },
      {
        ...
        position: 4,
        legally_mandated: true,
        config: { default_committee_roles: [ROLE.COMMITTEE_LAWS], report_acceptor_role: ROLE.SP_SECRETARY, thursday_cutoff_enabled: true, cutoff_time_pht: "23:59:59", require_all_committee_signatures: true, allow_secretary_advance: true },
      },
      {
      ...
      },
      {
        ...
        position: 6,
        legally_mandated: false,
        config: { assignee: ROLE.SECRETARIAT_STAFF, form_key: "form.sp_resolution.amendments_logging", require_comment: false, allow_comment: true, auto_complete: false },
      },
      {
      ...
      },
      {
        ...
        position: 8,
        legally_mandated: true,
        config: { assignee: ROLE.SP_SECRETARY, form_key: "form.document.final_number_assignment", require_comment: false, allow_comment: true, auto_complete: false },
      },
      {
      ...
      },
      {
        ...
        position: 10,
        legally_mandated: true,
        config: { assignee: ROLE.SECRETARIAT_STAFF, form_key: "form.document.transmittal_letter_to_mayor", require_comment: false, allow_comment: true, auto_complete: false, triggers_mayor_lapse_timer: true },
      },
      {
        ...
        position: 11,
        legally_mandated: true,
        config: { assignee: ROLE.MAYOR, allowed_outcomes: ["SIGNED", "VETOED", "LAPSED"], require_comment_on: ["VETOED"] },
      },
      {
        ...
        position: 12,
        legally_mandated: false,
        config: { assignee: ROLE.SP_SECRETARY, allowed_outcomes: ["OVERRIDE_SUCCEEDED", "OVERRIDE_FAILED"], require_comment_on: [] },
      },
      {
        step_key: "docketing",
        step_type: "action",
        ...
        position: 13,
        legally_mandated: true,
        config: { assignee: ROLE.SECRETARIAT_STAFF, form_key: "form.document.docketing", require_comment: false, allow_comment: true, auto_complete: false },
      },
      {
        ...
        position: 14,
        legally_mandated: false,
        config: { assignee: ROLE.SECRETARIAT_STAFF, form_key: "form.panlalawigan.transmission_logging", require_comment: false, allow_comment: true, auto_complete: false, triggers_panlalawigan_timer: true },
      },
      {
        ...
        position: 15,
        legally_mandated: true,
        config: { assignee: ROLE.SP_SECRETARY, allowed_outcomes: ["VALID", "VALID_IN_PART", "RETURNED", "DEEMED_APPROVED"], require_comment_on: ["VALID_IN_PART", "RETURNED"] },
      },
      {
        ...
        position: 16,
        legally_mandated: false,
        config: { assignee: ROLE.SP_SECRETARY, form_key: "form.panlalawigan.valid_in_part_action", require_comment: true, allow_comment: true, auto_complete: false },
      },
      {
        ...
        position: 17,
        legally_mandated: false,
        config: { assignee: ROLE.SP_SECRETARY, allowed_outcomes: ["RESOLVED_IN_PLACE", "ROUTED_TO_LEGAL", "ROUTED_TO_COMMITTEE", "REVISED_DIRECTLY"], require_comment_on: ["RESOLVED_IN_PLACE", "REVISED_DIRECTLY"] },
      },
      {
        ...
        position: 18,
        legally_mandated: false,
        config: { assignee: ROLE.LEGAL_OFFICER, allowed_outcomes: ["RESOLVED_IN_PLACE"], require_comment_on: ["RESOLVED_IN_PLACE"] },
      },
      {
        ...
        position: 19,
        legally_mandated: false,
        config: { assignee: ROLE.COMMITTEE_CHAIR, allowed_outcomes: ["RESOLVED_IN_PLACE"], require_comment_on: ["RESOLVED_IN_PLACE"] },
      },
      {
        ...
        position: 20,
        legally_mandated: false,
        config: { assignee: ROLE.SP_SECRETARY, allowed_outcomes: ["REPASS", "RESOLVED_DIRECTLY"], require_comment_on: ["REPASS", "RESOLVED_DIRECTLY"] },
      },
      {
        ...
        position: 21,
        legally_mandated: true,
        config: { assignee: ROLE.SECRETARIAT_STAFF, form_key: "form.document.portal_publication", require_comment: false, allow_comment: true, auto_complete: false },
      },
      {
        step_key: "archive",
        step_type: "action",
        ...
        position: 22,
        legally_mandated: false,
        config: { assignee: ROLE.RECORDS_OFFICER, form_key: "form.document.archive", require_comment: false, allow_comment: true, auto_complete: false },
      },
      {
        ...
        position: 23,
        legally_mandated: false,
        config: { condition_expression: JSON.stringify({ in: [{ var: "panlalawigan_outcome" }, ["VALID", "DEEMED_APPROVED"]] }), true_outcome: "TRUE", false_outcome: "FALSE" },
      },
      {
      ...
      },
      {
        ...
        position: 28,
        legally_mandated: false,
        config: { outcome_code: "REPASSED", final_document_status: null, emit_event: "workflow.instance.repassed" },
      },
    ],
    transition_rules: [
      { from_step_key: "intake_logging", to_step_key: "order_of_business_scheduling", outcome_filter: null, condition_expression: null, priority: 1, label: null },
      { from_step_key: "order_of_business_scheduling", to_step_key: "first_reading", outcome_filter: null, condition_expression: null, priority: 1, label: null },
      { from_step_key: "first_reading", to_step_key: "committee_referral", outcome_filter: null, condition_expression: null, priority: 1, label: null },
      
      { from_step_key: "committee_referral", to_step_key: "second_reading_vote", outcome_filter: "REPORT_ACCEPTED", condition_expression: null, priority: 1, label: "Committee report accepted by SP Secretary" },
      { from_step_key: "committee_referral", to_step_key: "second_reading_vote", outcome_filter: "SECRETARY_ADVANCED", condition_expression: null, priority: 2, label: "SP Secretary manually advanced" },
      ...
      { from_step_key: "vp_certification", to_step_key: "transmittal_letter_to_mayor", outcome_filter: "SIGNED", condition_expression: null, priority: 1, label: "Vice Mayor signed certified copy" },
      { from_step_key: "transmittal_letter_to_mayor", to_step_key: "mayor_review", outcome_filter: null, condition_expression: null, priority: 1, label: null },
      
      { from_step_key: "mayor_review", to_step_key: "docketing", outcome_filter: "SIGNED", condition_expression: null, priority: 1, label: "Mayor signed" },
      { from_step_key: "mayor_review", to_step_key: "docketing", outcome_filter: "LAPSED", condition_expression: null, priority: 2, label: "Lapsed into law" },
      { from_step_key: "mayor_review", to_step_key: "veto_override_vote", outcome_filter: "VETOED", condition_expression: null, priority: 3, label: "Mayor vetoed" },
      
      { from_step_key: "veto_override_vote", to_step_key: "docketing", outcome_filter: "OVERRIDE_SUCCEEDED", condition_expression: null, priority: 1, label: "Override succeeded" },
      { from_step_key: "veto_override_vote", to_step_key: "end_vetoed_override_failed", outcome_filter: "OVERRIDE_FAILED", condition_expression: null, priority: 2, label: "Override failed" },
      
      { from_step_key: "docketing", to_step_key: "panlalawigan_transmission_logging", outcome_filter: null, condition_expression: null, priority: 1, label: null },
      { from_step_key: "panlalawigan_transmission_logging", to_step_key: "panlalawigan_review", outcome_filter: null, condition_expression: null, priority: 1, label: null },
      
      { from_step_key: "panlalawigan_review", to_step_key: "portal_publication", outcome_filter: "VALID", condition_expression: null, priority: 1, label: null },
      { from_step_key: "panlalawigan_review", to_step_key: "portal_publication", outcome_filter: "DEEMED_APPROVED", condition_expression: null, priority: 2, label: "Deemed approved" },
      { from_step_key: "panlalawigan_review", to_step_key: "valid_in_part_action", outcome_filter: "VALID_IN_PART", condition_expression: null, priority: 3, label: null },
      { from_step_key: "panlalawigan_review", to_step_key: "returned_review", outcome_filter: "RETURNED", condition_expression: null, priority: 4, label: "Returned with objections" },
      
      { from_step_key: "valid_in_part_action", to_step_key: "valid_in_part_decision", outcome_filter: null, condition_expression: null, priority: 1, label: null },
      
      { from_step_key: "valid_in_part_decision", to_step_key: "portal_publication", outcome_filter: "RESOLVED_IN_PLACE", condition_expression: null, priority: 1, label: "Resolved as-is" },
      { from_step_key: "valid_in_part_decision", to_step_key: "legal_office_review", outcome_filter: "ROUTED_TO_LEGAL", condition_expression: null, priority: 2, label: null },
      { from_step_key: "valid_in_part_decision", to_step_key: "committee_revisions_review", outcome_filter: "ROUTED_TO_COMMITTEE", condition_expression: null, priority: 3, label: null },
      { from_step_key: "valid_in_part_decision", to_step_key: "portal_publication", outcome_filter: "REVISED_DIRECTLY", condition_expression: null, priority: 4, label: "Secretariat implements revisions" },
      
      { from_step_key: "legal_office_review", to_step_key: "portal_publication", outcome_filter: "RESOLVED_IN_PLACE", condition_expression: null, priority: 1, label: "Legal Officer's recommendation logged" },
      { from_step_key: "committee_revisions_review", to_step_key: "portal_publication", outcome_filter: "RESOLVED_IN_PLACE", condition_expression: null, priority: 1, label: "Committee Chair's recommendation logged" },
      
      { from_step_key: "returned_review", to_step_key: "portal_publication", outcome_filter: "RESOLVED_DIRECTLY", condition_expression: null, priority: 1, label: "Secretariat implements Panlalawigan recommendations" },
      { from_step_key: "returned_review", to_step_key: "end_repassed", outcome_filter: "REPASS", condition_expression: null, priority: 2, label: "Document returned to drafting" },
      
      { from_step_key: "portal_publication", to_step_key: "archive", outcome_filter: null, condition_expression: null, priority: 1, label: null },
      { from_step_key: "archive", to_step_key: "final_outcome_check", outcome_filter: null, condition_expression: null, priority: 1, label: null },
      
      { from_step_key: "final_outcome_check", to_step_key: "end_approved_and_released", outcome_filter: "TRUE", condition_expression: null, priority: 1, label: "panlalawigan_outcome in VALID, DEEMED_APPROVED" },
      { from_step_key: "final_outcome_check", to_step_key: "end_valid_in_part_resolved", outcome_filter: "FALSE", condition_expression: null, priority: 2, label: "panlalawigan_outcome in VALID_IN_PART, RETURNED" },
    ],
  },
};
...
export async function seedPhase1WorkflowDefinitions(db: any, documentTypeIds?: Record<string, string>) {
  ...
  for (const wf of ALL_WORKFLOWS) {
    ...
    await transaction.insert(definitions).values({
      id: defId,
      cityId: CITY_ID,
    ...
    const rulesToInsert = wf.version.transition_rules.map((rule: any, idx: number) => ({
      id: uuidv5(`wf-rule-${versionId}-${rule.from_step_key}-${rule.to_step_key}-${idx}`, WORKFLOW_SEED_NAMESPACE),
      definitionVersionId: versionId,
