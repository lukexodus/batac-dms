...
// RIGHT — access through validated config module
import { env } from '@batac/config/env';
  ...
  rules: {
    ...
    'no-restricted-syntax': [
      'error',
      {
        ...
        message: 'Access env variables through @batac/config/env, not process.env directly.',
      },
    ],
  },
};
