...
| ADR-INF-001 | Argon2 Package Selection | Docker / Compose (L2) | [View](../L-infrastructure-and-devops/l2-docker-and-docker-compose-specification-adrs/ADR-INF-001-argon2-package-selection.md) |
| ADR-INF-002 | PostgreSQL Docker Image: Bitnami vs Official | Docker / Compose (L2) | [View](../L-infrastructure-and-devops/l2-docker-and-docker-compose-specification-adrs/ADR-INF-002-postgresql-docker-image-bitnami-vs-official.md) |
| ADR-INF-003 | OCR Language Pack Bundling Strategy | Docker / Compose (L2) | [View](../L-infrastructure-and-devops/l2-docker-and-docker-compose-specification-adrs/ADR-INF-003-ocr-language-pack-building-strategy.md) |
| ADR-INF-004 | Nginx Domain Name Injection | Docker / Compose (L2) | [View](../L-infrastructure-and-devops/l2-docker-and-docker-compose-specification-adrs/ADR-INF-004-nginx-domain-name-injection.md) |
| ADR-INF-005 | TLS Certificate Provisioning | Docker / Compose (L2) | [View](../L-infrastructure-and-devops/l2-docker-and-docker-compose-specification-adrs/ADR-INF-005-tls-certificate-provisioning.md) |
| ADR-INF-006 | Production Secrets Management | Docker / Compose (L2) | [View](../L-infrastructure-and-devops/l2-docker-and-docker-compose-specification-adrs/ADR-INF-006-production-secrets-management.md) |
| ADR-INF-007 | Node.js Runtime Version | Docker / Compose (L2) | [View](../L-infrastructure-and-devops/l2-docker-and-docker-compose-specification-adrs/ADR-INF-007-nodejs-runtime-version.md) |
| ADR-INF-008 | pnpm Version Pinning via Corepack | Docker / Compose (L2) | [View](../L-infrastructure-and-devops/l2-docker-and-docker-compose-specification-adrs/ADR-INF-008-pnpm-version-pinning-via-corepack.md) |
| ADR-INF-009 | Backup Restore Test Container | Docker / Compose (L2) | [View](../L-infrastructure-and-devops/l2-docker-and-docker-compose-specification-adrs/ADR-INF-009-backup-restore-test-container.md) |
...
| ADR-REQ-003 | Workflow Engine | Key Design Decisions (Consolidated Ref) | [View](../../requirements-gathering/consolidated-architecture-and-requirements-reference-iteration-3.md#113-workflow-engine-updated-interview-2) |
| ADR-REQ-004 | Document Management | Key Design Decisions (Consolidated Ref) | [View](../../requirements-gathering/consolidated-architecture-and-requirements-reference-iteration-3.md#114-document-management-updated-interview-2) |
| ADR-REQ-005 | Document Numbering | Key Design Decisions (Consolidated Ref) | [View](../../requirements-gathering/consolidated-architecture-and-requirements-reference-iteration-3.md#115-document-numbering-updated-interview-2) |
| ADR-REQ-006 | Document Tracking (DTS) | Key Design Decisions (Consolidated Ref) | [View](../../requirements-gathering/consolidated-architecture-and-requirements-reference-iteration-3.md#116-document-tracking-dts-updated-interview-2) |
...
| ADR-REQ-013 | Delegation and Acting Authority | Key Design Decisions (Consolidated Ref) | [View](../../requirements-gathering/consolidated-architecture-and-requirements-reference-iteration-3.md#1113-delegation-and-acting-authority-significantly-updated-interview-2) |
...
| ADR-REQ-015 | Offline and Connectivity | Key Design Decisions (Consolidated Ref) | [View](../../requirements-gathering/consolidated-architecture-and-requirements-reference-iteration-3.md#1115-offline-and-connectivity-confirmed) |
| ADR-REQ-016 | Mobile and Device Support | Key Design Decisions (Consolidated Ref) | [View](../../requirements-gathering/consolidated-architecture-and-requirements-reference-iteration-3.md#1116-mobile-and-device-support-confirmed) |
...
| ADR-TST-001 | Certified Urgent Revocation (K2 §21, item 1) | Testing (K2) | [View](../K-testing/k2-workflow-engine-test-suite-design-adrs/ADR-TST-001-certified-urgent-revocation-k2-section-21-item-1.md) |
| ADR-TST-002 | OPERATIVE_IN_ITS_ENTIRETY` on a Non-Appropriation-Ordinance Instance (K2 §21, item 2) | Testing (K2) | [View](../K-testing/k2-workflow-engine-test-suite-design-adrs/ADR-TST-002-operative-in-its-entirety-on-a-non-appropriation-ordinance-instance-k2-section-21-item-2.md) |
| ADR-TST-003 | COMMITTEE_CHAIR` Assignee Resolution (K2 §21, item 3) | Testing (K2) | [View](../K-testing/k2-workflow-engine-test-suite-design-adrs/ADR-TST-003-committee-chair-assignee-resolution-k2-section-21-item-3.md) |
| ADR-TST-004 | Encoder ≠ Final Approver: Which Step Carries `is_final_approval = true` (K2 §21, item 4) | Testing (K2) | [View](../K-testing/k2-workflow-engine-test-suite-design-adrs/ADR-TST-004-encoder-not-equal-final-approver-which-step-carries-is-final-approval-equals-true-k2-section-21-item-4.md) |
| ADR-TST-005 | workflow_events` Immutability Test (K2 §21, item 5) | Testing (K2) | [View](../K-testing/k2-workflow-engine-test-suite-design-adrs/ADR-TST-005-workflow-events-immutability-test-k2-section-21-item-5.md) |
| ADR-TST-006 | MISSING_LAPSE_TRANSITION` Publish-Time Validation Test (K2 §21, item 6) | Testing (K2) | [View](../K-testing/k2-workflow-engine-test-suite-design-adrs/ADR-TST-006-missing-lapse-transition-publish-time-validation-test-k2-section-21-item-6.md) |
| ADR-TST-007 | MISSING_OUTCOME_TRANSITION` Publish-Time Validation Test (K2 §21, item 7) | Testing (K2) | [View](../K-testing/k2-workflow-engine-test-suite-design-adrs/ADR-TST-007-missing-outcome-transition-publish-time-validation-test-k2-section-21-item-7.md) |
| ADR-TST-008 | ARTA SLA Warning/Escalation Test Scope (K2 §21, item 8) | Testing (K2) | [View](../K-testing/k2-workflow-engine-test-suite-design-adrs/ADR-TST-008-arta-sla-warning-escalation-test-scope-k2-section-21-item-8.md) |
| ADR-TST-009 | DESIG-07 Typed Error Code (K2 §21, item 9) | Testing (K2) | [View](../K-testing/k2-workflow-engine-test-suite-design-adrs/ADR-TST-009-desig-07-typed-error-code-k2-section-21-item-9.md) |
...
| ADR-WFL-004 | Workflow Engine Error States and Instance-Creation Modeling | Workflow / UML (D3) | [View](../D-uml-and-diagrams/d3-state-machine-diagrams-adrs/ADR-WFL-004-workflow-engine-error-states.md) |
