# ADR-004: Committee List/Read Procedure
...
This is a missing-procedure gap of the same shape as a missing single-record read (ADR-005) — it is an omission in the original catalog, not a point of product ambiguity requiring a stakeholder decision.
