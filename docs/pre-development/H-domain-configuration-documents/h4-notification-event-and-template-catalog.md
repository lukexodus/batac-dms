...
- [L59–L68] 1. Introduction — Overview of the notifications module role, core Phase 1 requirements, event-driven architecture, and catalog organization.
- [L69–L114] 2. Purpose and Scope — Implementation goals, delivery channels by phase, out-of-scope details, and owned PostgreSQL schemas/tables.
- [L115–L146] 3. Delivery Infrastructure — Technical stack for Server-Sent Events (SSE), email exceptions, SMS timelines, and channel identifier definitions.
- [L147–L367] 4. Notification Event Catalog — Trigger events and consumer registry mapping for legislative, ARTA, and administrative actions.
  - [L153–L176] 4.1 Step Assignment Notification — Triggers when a workflow step is activated to notify the designated assignee via workflow.step.started event.
  - [L177–L198] 4.2 Document State Change Notification — Notifies affected users of document lifecycle phase transitions via document.state_changed event.
  - [L199–L222] 4.3 SLA Warning Notification — Warns assignees when 80% of the ARTA-configured SLA duration has elapsed using workflow.sla.warning.
  - [L223–L244] 4.4 SLA Breach Escalation Notification — Triggers supervisor and Records Officer notifications upon missed SLA deadlines via workflow.sla.breached.
  - [L245–L268] 4.5 SLA Critical Escalation Notification — Triggers high-priority alerts to supervisors, Records Officers, and Department Heads at 150% SLA threshold.
  - [L269–L292] 4.6 Mayor 10-Day Lapse-Into-Law Notification — Alerts the SP Secretary via workflow.approval.lapsed when the Mayor's 10-day review period expires.
  - [L293–L316] 4.7 Panlalawigan 30-Day Deemed Approval Notification — Alerts the SP Secretary via workflow.panlalawigan.deemed_approved when the Sangguniang Panlalawigan's 30-day review expires.
  - [L317–L345] 4.8 Complaint Respondent Notification `[B3 Gap — routing resolved by ADR-B2-4]` — Email/phone alerting for external respondents via ADR-B2-4 direct API call, bypassing the main event bus.
  - [L346–L367] 4.9 Session Security Notification `[B3 Gap]` — In-app notification sent to a displaced user when their active session is terminated due to multi-device login.
- [L368–L630] 5. Notification Template Catalog — Administrator-managed templating syntax and database configuration details for notification message bodies.
  - [L376–L393] 5.1 Template Framework — Template schema definition, identifier patterns, is_active status, and Phase 2 react-email rendering rules.
  - [L394–L420] 5.2 Template T-01: Step Assignment — In-App — In-app message configuration and payload variables for step routing alerts under workflow.step.started.
  - [L421–L437] 5.3 Template T-02: Step Assignment — Email (Phase 2) — Phase 2 email message setup and variables for step routing alerts under workflow.step.started.
  - [L438–L462] 5.4 Template T-03: Document State Change — In-App — In-app message payload and transition configuration for document lifecycle state changes.
  - [L463–L486] 5.5 Template T-04: SLA Warning — In-App — In-app alert format for 80% SLA warning thresholds using workflow instance context variables.
  - [L487–L511] 5.6 Template T-05: SLA Breach Escalation — In-App — In-app alert structure for supervisor/Records Officer notifications when SLA deadlines are first missed.
  - [L512–L535] 5.7 Template T-06: SLA Critical Escalation — In-App — In-app alert format for three-tier supervisor, Records Officer, and Department Head escalations at 150% SLA.
  - [L536–L558] 5.8 Template T-07: Mayor 10-Day Lapse — In-App — In-app alert for SP Secretary containing the verbatim 'RA 7160 Section 47' legal basis.
  - [L559–L582] 5.9 Template T-08: Panlalawigan 30-Day Deemed Approval — In-App — In-app alert for SP Secretary containing the verbatim 'RA 7160 Section 56(d)' legal basis.
  - [L583–L607] 5.10 Template T-09: Complaint Respondent Notification — Email — Phase 1 exception email template for citizen respondents containing complaint tracking and Secretariat details.
  - [L608–L630] 5.11 Template T-10: Session Displaced — In-App — In-app security alert template delivered to force-logged-out users upon their subsequent login.
- [L631–L647] 6. Mapping of Notification Events to Templates — Reference table mapping all nine notification events to their corresponding templates, channels, and delivery phases.
- [L648–L687] 7. Role-Based Notification Permissions — Matrix defining which roles receive step, SLA, or respondent alerts, plus self-service and delivery log permissions.
- [L688–L752] 8. Notes and Considerations — Known B3 gaps, email delivery staging, SLA timer confirmation, and verbatim legal basis constraints.
- [L753–L775] 9. Conclusion — Summary of Phase 1 notifications, required implementation decisions, and ongoing maintenance guidelines.
...
| 4 | Certification of Urgency bypass (4 events, B3 §7.23–7.26): **decided — no dedicated notification built**, `audit` consumer (already confirmed, B3 §8 rows 36–39) is sufficient | Not yet a section in this document | **Resolved — no notification built; see `a1-tasks/notif.md` Module Summary, resolved-and-closed notes following the Confirmed Spec Gaps block** |
| 5 | Thursday-cutoff / missing-committee-report (`workflow.multi_referral.cutoff_missed`, B3 §7.18): **decided — no dedicated notification built**, existing Order-of-Business red-flag UI (D3 §3.4, `[CONFIRMED]`: "not a state transition") and `audit` consumer (B3 §8 row 31) are sufficient | Not yet a section in this document | **Resolved — no notification built; see `a1-tasks/notif.md` Module Summary, resolved-and-closed notes following the Confirmed Spec Gaps block** |
